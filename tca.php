...
$TCA["tx_jkpoll_poll"] = Array (
	...
	"interface" => Array (
		"showRecordFieldList" => "hidden,starttime,endtime,fe_group,title,image,question,answers"
	),
...
//		"0" => Array("showitem" => "hidden;;1;;1-1-1,valid_till, title;;;;2-2-2, image;;;;3-3-3, question;;;richtext[paste|bold|italic|underline|formatblock|class|left|center|right|orderedlist|unorderedlist|outdent|indent|link|image]:rte_transform[mode=ts], answers")
		"0" => Array("showitem" => "hidden,valid_till, title;;;;1-1-1,question;;;richtext[paste|bold|italic|underline|formatblock|class|left|center|right|orderedlist|unorderedlist|outdent|indent|link|image]:rte_transform[mode=ts],answers, image;;;;2-2-2,title_tag,alternative_tag,width,height,link,clickenlarge")
	),
	"palettes" => Array (
