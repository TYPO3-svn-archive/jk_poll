...
*  Copyright notice
*
*  (c) 2004 Johannes Krausmüller (johannes.krausmueller@pdv.de)
*  All rights reserved
*
 ...
 *
 * @author	Johannes Krausmüller <johannes.krausmueller@pdv.de>
 */
...
class tx_jkpoll_pi1_wizicon {
	...
	function includeLocalLang()	{
		include(t3lib_extMgm::extPath("jk_poll")."locallang.php");
		return $LOCAL_LANG;
	}
}
